...
fleet first: routing 300 reasoning calls by minute headroom empties OpenRouter's whole day by
**`t=244s`** and drops 78 requests, while the same run judged on both windows drops 75.
