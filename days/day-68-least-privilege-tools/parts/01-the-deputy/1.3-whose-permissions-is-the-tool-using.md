...
permission must answer, and [4.4](../04-the-argument/4.4-what-a-refusal-must-not-tell-you.md) deals
...
- The two `return` statements are **deliberately identical**. "Not yours" and "not there" must be
  ...
  exist. [4.4](../04-the-argument/4.4-what-a-refusal-must-not-tell-you.md) is about this.
